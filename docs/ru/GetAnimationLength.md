...
Метод возвращает длину анимации в количестве кадров, указанном в редакторе последовательностей. Возвращает `-1`, если экземпляр последовательности пуст ( не указан индекс текущей последовательности )
