...
Метод возвращает структуру данных [локатора](/) в текущем кадре анимации по имени его канала в [редакторе последовательностей](https://manual.gamemaker.io/monthly/en/The_Asset_Editors/Sequences.htm).
